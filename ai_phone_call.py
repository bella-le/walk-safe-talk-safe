...
ELEVENLABS_VOICE_ID = os.environ.get('ELEVENLABS_VOICE_ID', 'FGY2WhTYpPnrIDTdsKH5')  # '21m00Tcm4TlvDq8ikWAM'
...
async def websocket_endpoint(websocket: WebSocket):
    ...
    messages = [{'role': 'system', 'content': 
        'You are on a phone call with this user. They are walking home, but the vibe of the area seems unsafe,' +
        ' so they called you to make it sound like you are having a conversation with them. Your name is Bella.' +
        ' You should keep checking in on the user every now and then on where they are and how much longer until' +
        ' their destination. Please start the conversation with "Hey, it\'s Bella! Are you there yet?"'}]
    while True:
